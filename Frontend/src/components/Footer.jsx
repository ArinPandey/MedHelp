    ...
    <footer className="bg-slate-900 text-gray-300 mt-20 border-t border-slate-800">
      <div className="max-w-7xl mx-auto py-12 px-6">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            <h3 className="font-semibold text-white mb-4 text-sm uppercase tracking-wider">Developer Links</h3>
            <div className="flex space-x-4">
              <a 
                href="https://www.linkedin.com/in/arin-pandey-74b872300" 
                target="_blank" 
                rel="noopener noreferrer" 
                className="text-gray-400 hover:text-blue-400 p-2 bg-slate-800 rounded-lg transition-colors"
              >
        ...
        <div className="mt-12 pt-8 border-t border-slate-800 text-center text-xs text-gray-500">
          <p>&copy; {currentYear} MedHelp AI. Built by Arin Pandey.</p>
        </div>
      </div>
    </footer>
  );
